...
/**
 * Dashboard HTML report core class
 *
...
public class DASHBOARD {
...

    {
        ...
        // InputStream input = new FileInputStream(curDir +
    ...
    public void initialloadReportHeader() throws IOException {
     ...
     * 
     * try { intialloadreportfile.write("<tr>");
     * intialloadreportfile.write("<td class=\"tsnorm"
     * +checksum.teststatus+"\" width='50px'>" + args[0] + "</td>");
     * intialloadreportfile
     * .write("<td class=\"tsnorm"+checksum.teststatus+"\"  width='200px'>" +
     * args[1] + "</td>");
     * intialloadreportfile.write("<td class=\"tsnorm"+checksum
     * .teststatus+"\"  width='200x'><a class=\tcindex\" href=\""
     * +"T24"+args[11].trim() + ".htm\">" + args[2] + "</a></td>");
     * intialloadreportfile.write("<td class=\"tsnorm"+checksum.teststatus+
     * "\"  width='200px'> <a class=\tcindex\" href=\"" + "TAP"+args[12].trim()
     * + ".htm\">" +args[3] + "</a></td>");
     * 
     * intialloadreportfile.write("<td class=\"tsnorm"+checksum.teststatus+
     * "\"  width='100px'>" + args[4] + "</td>");
     * intialloadreportfile.write("<td class=\"tsnorm"
     * +checksum.teststatus+"\"  width='100px'>" + args[5] + "</td>");
     * intialloadreportfile
     * .write("<td class=\"tsnorm"+checksum.teststatus+"\"  width='200px'>" +
     * args[6] + "</td>");
     * intialloadreportfile.write("<td class=\"tsnorm"+checksum
     * .teststatus+"\"  width='200px'>" + args[7] + "</td>");
     * 
     * if(checksum.teststatus == "fail") { intialloadreportfile.write(
     * "<td class=\"tsind\" width='50px'><img src = \"../ReportInfo/images/fail.jpg\" width=\"20\" height=\"20\"></td>"
     * ); } else { intialloadreportfile.write(
     * "<td class=\"tsind\" width='50px'><img src = \"../ReportInfo/images/pass.gif\" width=\"20\" height=\"20\"></td>"
     * ); } intialloadreportfile.write("</tr>");
     * 
     * } catch(Exception e) { System.out.println("reportbody" + e); }
     * 
     * }
     */
    public static void indexFooter() {
        try {
            ...
            HTMLINDEXReportFile.write("<tr><td colspan='2' class=\"tshead\">Test Case Summary</td></tr>");
            HTMLINDEXReportFile.write("<tr>");
            HTMLINDEXReportFile.write("<td class=\"pfhead\" width='200px'>Total Tests</td>");
            HTMLINDEXReportFile.write("<td class=\"pfind\" width='50px'>" + DashboardUtility.slno + "</td>");
            HTMLINDEXReportFile.write("</tr><tr>");
            HTMLINDEXReportFile.write("<td class=\"pfhead\" width='200px'>PASS </td>");
            HTMLINDEXReportFile.write("<td class=\"pfind\" width='50px'>" + indexpass + "</td>");
            HTMLINDEXReportFile.write("</tr><tr>");
            HTMLINDEXReportFile.write("<td class=\"pfhead\" width='200px'>FAIL </td>");
            HTMLINDEXReportFile.write("<td class=\"pfind\" width='50px'>" + indexfail + "</td>");
            HTMLINDEXReportFile.write("</tr><tr>");
    ...
    public static void reportFooter() {
        try {
            ...
            HTMLReportFile.write("</tr><tr>");
            HTMLReportFile.write("<td class=\"pfhead\" width='200px'>Execution End Time </td>");
            HTMLReportFile.write("<td class=\"pfind\" width='50px'>" + DashboardUtility.endTimeStamp + "</td>");
            HTMLReportFile.write("</tr><tr>");
            HTMLReportFile.write("<td class=\"pfhead\" width='200px'>Total Execution Time </td>");
            HTMLReportFile.write("<td class=\"pfind\" width='50px'>" + indexfail + "</td>");
            HTMLReportFile.write("</tr><tr>");
    ...
    public void initialloadFooter(String args[]) {
        try {
            ...
            intialloadreportfile.write("<tr><td colspan='2' class=\"tshead\">Test Case Summary</td></tr>");
            intialloadreportfile.write("<tr>");
            intialloadreportfile.write("<td class=\"pfhead\" width='200px'>Total Tests</td>");
            intialloadreportfile.write("<td class=\"pfind\" width='50px'>" + args[3] + "</td>");
            intialloadreportfile.write("</tr><tr>");
            intialloadreportfile.write("<td class=\"pfhead\" width='200px'>Total Count Check </td>");
            intialloadreportfile.write("<td class=\"pfind\" width='50px'>" + args[0] + "</td>");
            intialloadreportfile.write("</tr><tr>");
            intialloadreportfile.write("<td class=\"pfhead\" width='200px'>Total Checksum Check </td>");
            intialloadreportfile.write("<td class=\"pfind\" width='50px'>" + args[1] + "</td>");
            intialloadreportfile.write("</tr><tr>");
            intialloadreportfile.write("<td class=\"pfhead\" width='200px'>Total Table Check </td>");
            intialloadreportfile.write("<td class=\"pfind\" width='50px'>" + args[2] + "</td>");
    ...
    public void testDriverReportHeader() {
        try {
            ...
            testDriverReport
                    .write("<table BORDER=\"3\" BORDERCOLOR=\"clbg.gif\" BGCOLOR=\"#800080\" CELLPADDING=\"1\" CELLSPACING=\"1\" WIDTH=\"80%\" VALIGN=\"MIDDLE\" ALIGN=\"CENTER\">\n");
            testDriverReport.write("<thead>\n");
            testDriverReport.write("<tr>\n");
            testDriverReport
                    .write("<th><font face=\"Verdana\" size=\"8\">SCB </font><BR><BR><font face=\"Verdana\" size=\"6\">DASHBOARD</font><br>");
            testDriverReport.write("</tr>\n");
            testDriverReport.write("</thead>\n");
    ...
    public void WriteExecutionTimeInHeader() throws IOException {
        ...
        // SimpleDateFormat("yyyyMMdd HH:mm:ss").format(Calendar.getInstance().getTime());
        HTMLReportFile.write("<html>");
        HTMLReportFile
                .write("\n<head><link rel=\"stylesheet\" type=\"text/css\" href=\"../ReportInfo/report_theme.css\"></link></head>");
        ...
        // HTMLReportFile.write("\r \n<td height='63px'>" + "Automation Testing"
        // + "</td>");
        // HTMLReportFile
        // .write("\r \n<td height='63px' align='right'><img src = '..\\ReportInfo\\Images\\New-Temenos-logo.png'></td>");
        HTMLReportFile.write("\r \n</tr></table><hr class=\"divline\"> <BR>");
        ...
        HTMLReportFile.write("\n<tr>");
        /*
         * HTMLReportFile.write("\n<td class=\"subcont\" width='400px'>" +
         * args[0] + "</td>");
         * HTMLReportFile.write("\n<td class=\"subcont\" width='200px'>" +
         * args[1] + "</td>");
         */
        // HTMLReportFile.write("\n<td class=\"subcont\" width='200px'>" +
        // args[0] + "</td>");
         ...
         * ); HTMLReportFile.write("\n<tr><td width='300px' class=\"subcont\">"
         * + args[3] + "</td>");
         * HTMLReportFile.write("\n<td width='300px' class=\"subcont\">" +
         * args[4] + "</td>"); if (args[5] == "No Error") {
         * HTMLReportFile.write("\n<td width='300px' class=\"tsnorm\">" +
         * args[5] + "</td></tr>");
         * 
         * } else {
         * HTMLReportFile.write("\n<td width='300px' class=\"tsnormfail\">" +
         * args[5] + "</td></tr>"); }
         * HTMLReportFile.write("\r \n</tr></table> <hr class=\"divline\"> <BR>"
         * );
         */
    ...
    public void WriteReportHeader(String... args) throws IOException {
        // String timeStamp =new
        // SimpleDateFormat("yyyyMMdd HH:mm:ss").format(Calendar.getInstance().getTime());
        HTMLReportFile.write("<html>");
        HTMLReportFile
        ...
        // HTMLReportFile.write("\n<td class=\"subcont\" width='300px'>"
        // +StepDefinitionITCase.startTimeStamp + "</td>");
        // HTMLReportFile.write("\n<td class=\"subcont\" width='300px'>"
        // +StepDefinitionITCase.endTimeStamp + "</td>");
        // HTMLReportFile.write("\n<td class=\"subcont\" width='300px'>"
        // +StepDefinitionITCase.endTimeStamp + "</td>");
        // HTMLReportFile.write("\n<td class=\"subcont\" width='300px'>"
        // +timeStamp + "</td>");
    ...
    public void WriteindexReportHeader(String args[]) throws IOException {
        HTMLINDEXReportFile.write("<html>");
        HTMLINDEXReportFile
                .write("\n<head><link rel=\"stylesheet\" type=\"text/css\" href=\"../ReportInfo/report_theme.css\"></link></head>");
    ...
    public void DBWriteindexReportHeader(String args[]) throws IOException {
    ...
    public void testDriverReporFooter() {
        try {
            ...
            testDriverReport.write("<br>\n");
            testDriverReport
                    .write("<table BORDER=\"3\" BORDERCOLOR=\"#000000\" CELLPADDING=\"0\" CELLSPACING=\"0\" VALIGN=\"MIDDLE\" ALIGN=\"CENTER\" width='350px' height='180px'>\n");
            testDriverReport.write("<tr>\n");
            testDriverReport
                    .write("<td colspan='2' ALIGN=\"CENTER\" BGCOLOR=\"#33ADFF\"><font size=\"5\" face=\"Verdana\"><b>Execution Time</b></font></td>\n");
            testDriverReport.write("</tr>\n");
    ...
    public void reportindexbody(String args[]) {
        try {
            ...
            HTMLINDEXReportFile.write("\n<td class=\"tsnorm\" width='200px'> <a class=\tcindex\" href=\""
                    + args[1].trim() + ".htm\">" + args[1] + "</a></td>");
            HTMLINDEXReportFile.write("<td class=\"tsnorm\"  width='155px'>" + args[2] + "</td>");
            /*
             * HTMLINDEXReportFile.write("<td class=\"tsnorm\"  width='155px'>"
             * + StepDefinitionITCase.startTimeStamp + "</td>");
             * HTMLINDEXReportFile.write("<td class=\"tsnorm\"  width='155px'>"
             * + StepDefinitionITCase.endTimeStamp + "</td>");
             * HTMLINDEXReportFile.write("<td class=\"tsnorm\"  width='155px'>"
             * + StepDefinitionITCase.differenceValue + "</td>");
             */
            if (DASHBOARD.Currentteststatus.equals("fail")) {
                indexfail += 1;
                HTMLINDEXReportFile
                        .write("<td class=\"tsind\" width='50px'><img src = \"../ReportInfo/images/fail.jpg\" width=\"20\" height=\"20\"></td>");
            } else if (DASHBOARD.Currentteststatus.equals("Warn")) {
                HTMLINDEXReportFile
                        .write("<td class=\"tsind\" width='50px'><img src = \"../ReportInfo/images/warning.gif\" width=\"20\" height=\"20\"></td>");
            } else {
                indexpass += 1;
                HTMLINDEXReportFile
                        .write("<td class=\"tsind\" width='50px'><img src = \"../ReportInfo/images/pass.gif\" width=\"20\" height=\"20\"></td>");
            }
    ...
    public void DBreportindexbody(String args[]) {
        try {
            ...
            DBHTMLINDEXReportFile.write("\n<td class=\"tsnorm" + DASHBOARD.Currentteststatus + "\"  width='50px'>"
                    + args[5] + "</td>");
            DBHTMLINDEXReportFile.write("<td class=\"tsnorm" + DASHBOARD.Currentteststatus
                    + "\" width='400px'> <a class=\tcindex\" href=\"" + args[0] + "_" + args[1] + "_" + args[2].trim()
                    + ".htm\">" + args[2] + "</a></td>");
            DBHTMLINDEXReportFile.write("<td class=\"tsnorm" + DASHBOARD.Currentteststatus + "\" width='400px'>"
                    + args[3] + "</td>");
            DBHTMLINDEXReportFile.write("<td class=\"tsnorm" + DASHBOARD.Currentteststatus + "\"  width='300px'>"
                    + args[4] + "</td>");
            if (DASHBOARD.Currentteststatus.equals("fail")) {
                DBHTMLINDEXReportFile
                        .write("<td class=\"tsind\" width='50px'><img src = \"../ReportInfo/images/fail.jpg\" width=\"20\" height=\"20\"></td>");
    ...
    public void reportbody(String args[]) {
        try {
            HTMLReportFile.write("<tr>");
            HTMLReportFile.write("<td class=\"tsnorm" + DASHBOARD.Currentfieldstatus + "\" width='75px'>" + args[0]
                    + "</td>");
            HTMLReportFile.write("<td class=\"tsnorm" + DASHBOARD.Currentfieldstatus + "\"  width='155px'>" + args[1]
                    + "</td>");
            HTMLReportFile.write("<td class=\"tsnorm" + DASHBOARD.Currentfieldstatus + "\" width='285px'>" + args[2]
                    + "</td>");
            // HTMLReportFile.write("<td class=\"tsnorm"+DASHBOARD.Currentfieldstatus+"\" width='285px'>"
            // +args[3] + "</td>");
